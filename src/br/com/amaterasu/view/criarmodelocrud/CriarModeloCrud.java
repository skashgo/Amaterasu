 ...
 * @author Maykon
 */
public class CriarModeloCrud extends javax.swing.JFrame implements IPainelRodape {

    private ObserverAction observerAction;
    private List<IPainel> paineis = new ArrayList<IPainel>();

    public CriarModeloCrud() {
        initComponents();
        ...
        paineis.add(new CriarModeloCrud_painel1());
...
//        painelRodape1.setJanelaFinalizavel(2, 3);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(painelRodape1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
