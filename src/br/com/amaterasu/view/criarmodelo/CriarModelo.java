 ...
 * @author Maykon
 */
public class CriarModelo extends javax.swing.JFrame implements IPainelRodape {
    ...
    public CriarModelo() {
        ...
        paineis.add(new CriarModelo_painel1());
        paineis.add(new CriarModelo_painel2());
