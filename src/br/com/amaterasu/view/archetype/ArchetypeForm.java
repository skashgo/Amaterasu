 ...
 * @author Maykon
 */
public class ArchetypeForm extends javax.swing.JFrame implements IPainelRodape {

    private ObserverAction observerAction;
    private List<IPainel> paineis = new ArrayList<IPainel>();

    public ArchetypeForm() {
        initComponents();
        ...
        paineis.add(new Archetype_painel1());
...
//        painelRodape1.setJanelaFinalizavel(2, 3);
    ...
    public void doFinalizar() {
        try {
            painelRodape1.setPainel(paineis.get(painelRodape1.getJanelaAtual()));
            ModelArchetype.i().save();
            JOptionPane.showMessageDialog(null, "Archetype adicionado com sucesso!");
            dispose();
