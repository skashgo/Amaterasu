 ...
 *
 */
public interface IVerificacaoContratoObservacaoParecerDAO extends IGenericDAO<VerificacaoContratoObservacoesParecer> {
	 ...
	 * @return
	 */
	VerificacaoContratoObservacoesParecer findById_Fonte(Integer id, Character fonte, VerificacaoContratoVO vc);
