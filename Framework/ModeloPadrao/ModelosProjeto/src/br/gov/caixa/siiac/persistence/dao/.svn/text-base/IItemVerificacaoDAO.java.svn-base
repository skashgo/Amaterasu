 ...
 *
 */
public interface IItemVerificacaoDAO extends IGenericDAO<ItemVerificacao> {
	
	List<ItemVerificacao> getAllNotBloco(BlocoChecklistProduto bloco) throws DAOException;
	
	List<ItemVerificacao> getAllChecklist(BlocoChecklistProduto bloco) throws DAOException;
}
