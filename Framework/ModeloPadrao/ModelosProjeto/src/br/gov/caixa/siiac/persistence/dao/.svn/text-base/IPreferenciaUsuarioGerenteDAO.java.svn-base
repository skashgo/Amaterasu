 ...
 *
 */
public interface IPreferenciaUsuarioGerenteDAO extends IGenericDAO<PreferenciaUsuarioGerente>{

	public  void saveAll(String matricula,
			List<PreferenciaUsuarioGerente> gerentes);
