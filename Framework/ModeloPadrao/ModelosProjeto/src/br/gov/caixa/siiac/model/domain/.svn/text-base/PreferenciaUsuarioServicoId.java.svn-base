 ...
 */
@Embeddable
public class PreferenciaUsuarioServicoId implements java.io.Serializable {
	
	private static final long serialVersionUID = 3132313143411L;
	...
	@Column(name = "nu_servico_verificacao", nullable = false)
