 ...
 *
 */
public interface IVerificacaoContratoBO {

	List<VerificacaoContratoVO> listVerificacaoVOByContrato(Contrato contrato) throws Exception;
	
	String obtemSituacaoContrato(Integer nuContrato);
	
	/**
	 * @param nuVerificacaoContrato
	 * @return
	 */
	VerificacaoContrato findById(Integer nuVerificacaoContrato);
