 ...
 */
@Embeddable
public class LogEnvioParecerId implements Serializable {
		...
		public LogEnvioParecerId() {
		}

		public LogEnvioParecerId(int nuParecer, Short aaParecer,
				Short nuUnidade, Short nuNatural) {
