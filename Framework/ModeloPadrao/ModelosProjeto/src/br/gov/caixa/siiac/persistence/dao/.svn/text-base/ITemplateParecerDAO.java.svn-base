 ...
 *
 */
public interface ITemplateParecerDAO extends IGenericDAO<TemplateParecer> 
{
	/**
	...
	/**
	 * Busca o template do parecer de acordo com o serviço de verificação produto e o resultado da verificação
