 ...
 *
 */
public interface ITemplateNotificacaoBO 
{
	public void merge(TemplateNotificacao templateNotificacao);
	
	public List<TemplateNotificacao> findAll();
	
	public List<TemplateNotificacao> getListTemplateNotificacaoFiltroSimples(FilterBase filtro)  throws SIIACException ;
	
	public List<TemplateNotificacao> getListTemplateNotificacaoFiltroAvancado(FilterBase filtro) throws SIIACException;
	...
	public Boolean exist(TemplateNotificacao templateNotificacao, Boolean isAlteracao) throws SIIACException;
}
