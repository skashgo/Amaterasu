...
@Repository
@Scope("prototype")
public class ServicoVerificacaoDAO extends GenericDAO<ServicoVerificacao> implements IServicoVerificacaoDAO {

	/**
	 * @param persistenceClass
	 */
	public ServicoVerificacaoDAO() {
		super(ServicoVerificacao.class);
	}
}
