...
@Embeddable
public class ControleNumeroParecerId implements Serializable {
	...
	public ControleNumeroParecerId() {
	}
	
	public ControleNumeroParecerId(int nuParecer, Short aaParecer, Short nuUnidade, int nuNatural) {
