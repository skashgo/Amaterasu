 ...
 *
 */
public interface IPreferenciasUsuarioCategoriaProdutoDAO extends IGenericDAO<PreferenciasUsuarioCategoriaProduto> {

	
	public List<PreferenciasUsuarioCategoriaProduto> findByUsuario(String matricula);
	
	void deleteAll(String matricula, List<PreferenciasUsuarioCategoriaProduto> categorias);

	void saveAll(String matricula, List<PreferenciasUsuarioCategoriaProduto> categorias);
