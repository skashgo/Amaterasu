 ...
 * @author Gis Consult
 */
public class AtualizaPrazoVerificacaoBOTest extends TestWithSpring {
	
	@Autowired
	private IAtualizaPrazoVerificacaoBO atualizaPrazoVerificacaoBO;
	
	@Test
	public void testAtualizaPrazoVerificao() {
		try {
			atualizaPrazoVerificacaoBO.atualizaPrazoVerificao(1);
		} catch (Exception e) {
			e.printStackTrace();
			fail();
		}
